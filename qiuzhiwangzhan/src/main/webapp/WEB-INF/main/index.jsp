...
<div id="body">
	...
	<c:if test="${!empty loginOper}">
		<li><a href="backjob/mycome.jsp">我的个人首页</a></li>
		<li class="current"><a rel="nofollow" href="selectFiled">查看职位</a></li>
	</c:if>
	<c:if test="${!empty loginSysuser}"><li><a rel="nofollow"  onclick="location.href='toxiu1.do';">修改密码</a></li></c:if>
...
<dl class="collapsible_menu">
	...
	<div id="username" font-size:12px;height:50%><span>欢迎你，</span><span>${username }</span></div>
...
<!--  -->
    ...
    <div id="container">
        ...
        <input type="text" id="search_input" placeholder="请输入公司名称" name="comName"  tabindex="1" value="${param.comName }"  />
            <input type="submit" id="search_button" value="搜索" onclick="location.href='tocha.do';"/>
	...
	<dd><a href="selectJobIofosByJobIndex?jobName.jnid=${name3.jnid}"><c:out value="${name3.jnname}"></c:out></a></dd>
			...
			<div id="home_banner">
	            <ul class="banner_bg">
	                    ...
	                    <a href="https://user.lu.com/user/lpreg?action=se_lu&seo=se_lu&marketFeedbackCode=eyJ1cmxUaWQiOiItNTAxIiwidXJsU291cmNlIjoiNTAxIn0"><img src="style1/images/d05a2cc6e6c94bdd80e074eb05e37ebd.jpg" width="612" height="160" alt="好买基金——来了就给100万" /></a>
	                </li>
	                	                <li  class="banner_bg_2" >
	                    <a href="http://sports.qq.com/" target="_blank"><img src="style1/images/c9d8a0756d1442caa328adcf28a38857.jpg" width="612" height="160" alt="世界杯放假看球，老板我也要！" /></a>
	                </li>
	                	                <li  class="banner_bg_3" >
	                    <a href="http://vacations.ctrip.com/?isctrip=T&ouid=vacation"><img src="style1/images/d03110162390422bb97cebc7fd2ab586.jpg" width="612" height="160" alt="出北京记——第一站厦门" /></a>
	                </li>
	                	            </ul>
