...
<div class="nr">  
          <div class="bft_f">
            ...
            <c:forEach items="${admin}" var="c" varStatus="s" >
            <div class="bft_f_2">
            	<ul>
                	<li><span>${c.username}</span></li>
         
                    <li><span id="gname1"   value="${c.age}">${c.age}</span></li>
                    <li>${c.edu}</li>
                    <li>${c.workto}</li>
                    <li><a  onclick='location.href="index41.do?gn=${c.gn}"'/><img src="sou/shenqing.jpg"></a></li>
                </ul>
            </div>
            </c:forEach>
